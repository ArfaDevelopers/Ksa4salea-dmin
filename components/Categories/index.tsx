                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="flex items-center">
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:bg-green-500"></div>
                          <div className="absolute w-5 h-5 bg-white border border-gray-300 rounded-full shadow left-1 top-0.5 peer-checked:translate-x-5 peer-checked:border-green-500 transition-transform"></div>
                        </label>
                      </div>
                    </td>
                    <td className="px-6 py-4">
